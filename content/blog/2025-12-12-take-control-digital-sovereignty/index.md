...
Here's the good news: you can protect yourself. You can protect your family. And in doing so, you can help protect Norway.
...
Imagine waking up tomorrow and finding you can't log into your Windows PC. Not because of a technical glitch - but because your account was suspended.

Sound far-fetched? Consider:

**Windows 11 now requires a Microsoft account.** Microsoft has been [progressively eliminating the ability to use Windows with a local account](https://www.windowslatest.com/2025/10/07/microsoft-confirms-windows-11-to-require-microsoft-account-internet-during-oobe-tested/). The latest Windows 11 builds make a Microsoft account mandatory during setup.
...
**Accounts can be suspended.** Microsoft's terms of service give them broad authority to suspend accounts. And as we've seen with the [US sanctions against the International Criminal Court](/blog/2025-12-11-digital-sovereignty-moral-independence/) - the world's war crimes tribunal - when the US government wants to cut off access to services, American companies comply.

### Ask the Iranians

People in sanctioned countries know exactly what this looks like. In Iran, Cuba, Syria, and other sanctioned nations:
...
Iranian developers have [written extensively](https://dev.to/hamed/my-life-as-a-developer-in-iran-under-us-sanctions-2bkp) about being locked out of GitHub, losing access to their own code repositories, and being cut off from the tools the rest of the world takes for granted.
...
You don't buy house insurance when your house is already burning. You buy it before, hoping you'll never need it.
...
Here's the honest truth: switching tools is hard.
...
When the lockout comes, you have three options:
...
You don't have to change everything at once. Start with the most critical areas:

### Documents and Office Work

**Instead of:** Microsoft Office (Word, Excel, PowerPoint)
**Consider:** LibreOffice (free, open source, reads/writes Microsoft formats)
...
**Instead of:** Outlook.com, Gmail
**Consider:** ProtonMail (Switzerland), Tutanota (Germany), or self-hosted options

At minimum, ensure you can export your email and have a backup email address on a different provider.

### Cloud Storage

**Instead of:** OneDrive, Google Drive
**Consider:** Nextcloud (can self-host or use European providers), Tresorit (Switzerland)

The key isn't necessarily moving everything - it's having copies of critical files somewhere you control.

### Operating System

**Instead of:** Windows with mandatory Microsoft account
**Consider:** Linux (Ubuntu, Fedora, Linux Mint for beginners)

This is the biggest change, but also the most complete insurance. Linux doesn't require anyone's permission to use.

### Photos and Memories

**Critical:** Ensure your family photos exist somewhere other than OneDrive/iCloud/Google Photos. Local backup. Multiple copies. These are irreplaceable.

## The Interoperability Bonus

Here's something interesting: when you use open standards, interoperability often gets better, not worse.
...
This isn't just about protecting yourself. Every choice you make shapes Norway's digital independence.
...
Norwegian Minister of Digitalization Karianne Tung has called for [exit strategies from foreign cloud providers](/blog/2025-12-01-norway-exit-strategy/). But government policy alone can't create digital sovereignty. It requires citizens and organizations making different choices.
...
Your personal computer is one thing. But what about your job?
...
We didn't end up dependent on American technology by accident. Microsoft created genuinely excellent products. They standardized how we work with documents. They made computers accessible to ordinary people. The productivity gains they enabled are immeasurable.

But somewhere along the way, a dependency became a vulnerability.

### A Pattern, Not an Accident

This isn't the first time dominant tech companies have used their position to eliminate choice.

In the 1990s, Microsoft [bundled Internet Explorer with Windows](https://en.wikipedia.org/wiki/United_States_v._Microsoft_Corp.) and used its operating system monopoly to crush Netscape Navigator - then the leading web browser. The US Department of Justice sued, and in 2001, a federal court found Microsoft guilty of maintaining its monopoly through anticompetitive means.

Judge Thomas Penfield Jackson's [findings of fact](https://www.justice.gov/atr/us-v-microsoft-courts-findings-fact) were damning:
...
The question isn't whether the tools we use are good - many of them are excellent. The question is whether you want your ability to use your own computer, access your own files, and do your own work to depend on a foreign corporation's continued permission.
...
**This week:**
1. Download [LibreOffice](https://www.libreoffice.org/) and open a few of your documents
...
- [Microsoft confirms Windows 11 to require Microsoft account, internet during setup - Windows Latest](https://www.windowslatest.com/2025/10/07/microsoft-confirms-windows-11-to-require-microsoft-account-internet-during-oobe-tested/)
- [Windows 11 Local Account Crackdown: Microsoft Account May Soon Be Mandatory - Android Headlines](https://www.androidheadlines.com/2025/10/windows-11-local-account-crackdown-removal-microsoft-account-mandatory.html)
- [Microsoft Blocks Online Account Bypass on Windows 11 - TechPowerUp](https://www.techpowerup.com/341656/microsoft-blocks-online-account-bypass-on-windows-11/)

**Microsoft Antitrust Case:**
- [United States v. Microsoft Corp. - Wikipedia](https://en.wikipedia.org/wiki/United_States_v._Microsoft_Corp.)
- [US v. Microsoft: Court's Findings of Fact - Department of Justice](https://www.justice.gov/atr/us-v-microsoft-courts-findings-fact)
- [The Microsoft Case: A Brief Summary - Stanford](https://cs.stanford.edu/people/eroberts/cs201/projects/corporate-monopolies/development_microsoft.html)

**Sanctions and Service Access:**
- [My life as a developer in Iran under US sanctions - DEV Community](https://dev.to/hamed/my-life-as-a-developer-in-iran-under-us-sanctions-2bkp)
- [GitHub blocked in Iran - Hacker News discussion](https://news.ycombinator.com/item?id=20531038)
- [US sanctions are depriving Iranians of access to online services - Access Now](https://www.accessnow.org/us-sanctions-iranian-internet/)
