...
{{< metadata-sidebar >}}
{{< highlight-card id="who-this-is-for" >}}
{
  "icon": "groups",
  "title": "Who This Is For",
  "description": "Operations teams in larger organizations responsible for setting up and managing PC/Mac fleets. If your developers use managed machines deployed via Intune (Windows) or Jamf (macOS), these scripts automate the entire developer toolchain rollout.",
  "style": "tertiary"
}
{{< /highlight-card >}}
...
{{< side-by-side id="side-by-side-3" >}}
{
  "left": [
    ...
    },
    {
      ...
      "icon": "usb",
      "title": "USB Testing",
      "description": "No Intune? No problem. Scripts can be copied to a USB stick for manual testing on Windows PCs — useful for testing in isolated environments or before MDM is set up.",
      "style": "primary"
    }
  ],
  "right": [
...
{{< highlight-card id="help-wanted-silent-wsl2-install" >}}
{
  "icon": "help_outline",
  "title": "Help Wanted: Silent WSL2 Install",
  "description": "The biggest unsolved problem: automating WSL2 install on Windows via Intune. WSL2 requires enabling Windows features and a reboot, which is tricky to do silently in an MDM pipeline. If you have experience with Intune and WSL2 deployment, we'd love your help.",
  "style": "secondary"
}
{{< /highlight-card >}}
